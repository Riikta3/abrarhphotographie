    ...
    <section className='relative min-h-screen h-screen flex items-center justify-center overflow-hidden'>
      ...
      <div className='relative z-30 text-center text-white max-w-4xl mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        <div className='mt-8 text-center'>
          ...
          <a href='https://www.instagram.com/abrar.hphotographie/' target='_blank' rel='noopener noreferrer' className='inline-flex items-center text-accent-on-photo hover:text-accent-on-photo/80 transition-colors font-medium text-lg' data-testid='link-hero-instagram'>
